...
export SPREAD_ENV="NESTED_CUSTOM_IMAGE_URL=https://storage.googleapis.com/snapd-spread-tests/images/pc-amd64-24-stable-core24_edge/pc.img.xz NESTED_SPREAD_TESTS=external:ubuntu-core-24-64:tests/smoke/"
