...
export SPREAD_ENV="NESTED_CUSTOM_IMAGE_URL=https://storage.googleapis.com/snapd-spread-tests/images/pc-amd64-24-beta-snapd_beta/pc.img.xz  NESTED_SPREAD_TESTS=$NESTED_SPREAD_TESTS"
